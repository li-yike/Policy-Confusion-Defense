...
def run_clone(expert_name, expert_data_file,savepath,limit_trajs=4, epoch=30,num_rollouts = 100,render = False): 
    ...
    savepath1="/root/leak_result/BC_learned/data/Walker2d-Ant"     ################
    ...
    model_name = 'models/Walker2d-Ant' + expert_name+"_epoch="+ str(epoch) +"_limit-trajs="+ str(limit_trajs) + '_cloned_model_3.h5'###_cloned_model_2.h5
    print(model_name)
    ...
    with tf.Session():
        ...
        #output_file_name = 'data/' + expert_name + '_' + str(num_rollouts) + "_algo="+algo+"_epoch="+ str(epoch)+ "_limit-trajs="+ str(limit_trajs) + '_clone.pkl'
        output_file_name = expert_name + '_' + str(num_rollouts) + "_algo="+algo+"_epoch="+ str(epoch)+ "_limit-trajs="+ str(limit_trajs) + '_clone_3.pkl' #################clone_2
...
def main():
    ...
    parser.add_argument('--limit_trajs',type=int,default=100)### 4

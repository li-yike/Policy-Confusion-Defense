...
if __name__ == "__main__":
    ...
    os.makedirs('f-IRL/expert_data/states/', exist_ok=True)
    os.makedirs('f-IRL/expert_data/actions/', exist_ok=True)
    torch.save(expert_states_sto, f'f-IRL/expert_data/states/{env_name}_{seed}_sto.pt')
    torch.save(expert_states_det, f'f-IRL/expert_data/states/{env_name}_{seed}_det.pt')
    torch.save(expert_actions_sto, f'f-IRL/expert_data/actions/{env_name}_{seed}_sto.pt')
    torch.save(expert_actions_det, f'f-IRL/expert_data/actions/{env_name}_{seed}_det.pt')